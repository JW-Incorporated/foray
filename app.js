...
function epRow(item, idx, ctx, nextIdx) {
  ...
  return `<div class="ep-row">
    ...
    <div class="info">
      ...
      <div class="s">${joinMeta(showNameLink(item.show), fmtDur(episodeMinutes(item)), esc(dateStr), progHtml)}</div>
    </div>
...
function archivedRow(item, idx, ctx) {
  ...
  return `<div class="ep-row gone">
    ...
    <div class="info">
      ...
      <div class="s">${named
        ? joinMeta(showNameLink(item.show), fmtDur(episodeMinutes(item)), esc(dateStr))
    ...
    <div class="page">
      <div class="page-head">
        ...
        <div>
          ...
          <p class="fp-s-show">${joinMeta(item.show ? showNameLink(item.show) : "", fmtDur(episodeMinutes(item)), esc(dateStr))}</p>
        </div>
      </div>
...
function upNextRow(r, idx, total) {
  ...
  const sub = state === "live"
    ? joinMeta(esc(item.show || ""), fmtDur(episodeMinutes(item)))
    : state === "archived"
