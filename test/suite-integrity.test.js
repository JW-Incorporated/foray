...
const FLOORS = {
  ...
  "test/prepare-dist-out.test.js": 4, // round-3 audit, L4 (ci-release-15): new -- prepare-dist refuses --out at the checkout, an ancestor, a .git dir or a bare --out, and deletes nothing // round-3 audit, L4 (tests-1): new -- the Playwright fixture serves sw.js stamped with the served deploy id, so a 'new deploy' really re-installs
