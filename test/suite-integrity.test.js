...
const FLOORS = {
  ...
  "player/foray-queue.test.js": 44, // audit round 3 integration: the real post-merge count, 38 -> 44 // F-90 (2026-09-11): the jingle item asset is the interlude asset; 37 -> 38
  ...
  "player/html-audio-backend.test.js": 113, // audit round 3 integration: the real post-merge count, 112 -> 113
  ...
  "tools/generation/relay.test.mjs": 33, // round-3 audit (L5): the default port is 8788, not the retired events server's 8787; 32 -> 33 // a leftover reply never answers a new run, web pages and foreign Hosts are refused, /answer and /reset need the run token, header ids cannot escape the queue; 27 -> 32
  ...
  "tools/segments/politeness.test.mjs": 19, // audit round 3 integration: the real post-merge count, 11 -> 19 // round-3 audit: L4 +1, the User-Agent scan covers api/ too (arch-drift-14); L8 +3, discardBody; 7 -> 11
