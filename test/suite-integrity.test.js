...
const FLOORS = {
  ...
  "test/episode-description-links.test.js": 30, // audit round 2 (2026-09-23): a stamp-led line is a 44px chapter row, keeps no stray newline, stays inline beside a link or a second stamp, and stays text past the end; 25 -> 30 | earlier: +3 (2026-09-18): the notes collapse into a closed <details> so artwork leads the page, the timestamps still bind inside it, and chapters stay out of it
