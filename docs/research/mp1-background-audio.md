...
| Issue | Status change |
|---|---|
| **#35** (this spike) | **Answered from source and documentation, not from a device** — the emulator attempt is reported in §6.2. Summarised in one comment there; left open for a founder to close |
