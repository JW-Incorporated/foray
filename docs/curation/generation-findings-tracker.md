...
| F-72 | the rare-word floor refuses the spine's own seed window (shares 0.53–0.85 refused for having < 3 rare words); 3 of 14 available tape beats lost in attempt 5 | High | fix in flight | `fix/f72-seed-window-floor` (agent PR): seed window judged on share alone | attempt 6 |
