...
2026-08-18, and is **1.96 MB** now that the catalogue ships as a bounded slice
(`docs/mobile-shell.md` §3) — so **1.04 MB of headroom**, and this argument does not
turn on it. One Foray's narration is **11.1 MB: 10x the remaining headroom and 3.7x
