...
ruleset, per RULINGS-2 P2 test criteria. #100 chosen to avoid any
collision with real item numbers (verified against the live file, both
OPEN and DONE sections, before filing).
